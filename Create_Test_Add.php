...
$sql = "INSERT INTO  new_test (Id_New_Test,year,term,subjectID,Subject,subjectname,type,level,score,time,creater) VALUES ('','$yeardb','$termdb','$subjectdb0','$subjectdb1','$subjectdb3','$typedb','$level','$score','$time','$creater')";
//echo $sql;
mysql_query($sql);
