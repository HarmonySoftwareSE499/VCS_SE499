...
$time = $_POST['time'];
 ...
 $use_point = $_POST['point']*$_POST['trpoint']/100;
...
$sql = "INSERT INTO  new_test (Id_New_Test,year,term,subjectID,Subject,subjectname,type,level,point,trpoint,use_point,score,time,creater) VALUES ('','$yeardb','$termdb','$subjectdb0','$subjectdb1','$subjectdb3','$typedb','$level','$point','$trpoint','$use_point','$score','$time','$creater')";
//echo $sql;
mysql_query($sql);
